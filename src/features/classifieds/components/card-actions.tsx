...
export const CardActions = ({ slug }: CardActionsProps) => (
  <div className="mt-4 grid grid-cols-2 gap-3">
    <Button
      className="group w-full bg-white border-primary text-primary hover:bg-primary/5 hover:border-primary/90 transition-all duration-300"
      asChild
      variant="outline"
      size="sm"
    >
    ...
    <Button
      className="group w-full bg-primary hover:bg-primary/90 transition-all duration-300"
      asChild
      size="sm"
    >
