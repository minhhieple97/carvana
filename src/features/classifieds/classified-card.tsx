    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="group grid grid-rows-[auto,1fr] h-full rounded-md sm:rounded-lg overflow-hidden shadow-sm sm:shadow-md hover:shadow-lg sm:hover:shadow-xl transition-all duration-300 bg-white text-[11px] xs:text-xs sm:text-sm"
        >
