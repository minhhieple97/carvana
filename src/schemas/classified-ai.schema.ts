...
export const ClassifiedTaxonomyAISchema = z.object({
  ...
  modelVariantId: z.number().nullable().describe('The model variant ID of the vehicle'),
  modelVariant: z.string().nullable().describe('The model variant of the vehicle'),
});
...
export const ClassifiedDetailsAISchema = z.object({
  ...
  vrm: z.string().describe("The vehicle registration mark. If unable to detect use 'UNKNOWN'"),
  ...
  transmission: z.nativeEnum(Transmission).describe('THe transmission of the vehicle'),
